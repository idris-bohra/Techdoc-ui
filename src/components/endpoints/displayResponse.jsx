...
class DisplayResponse extends Component {
    ...
    return (
      <>
        <div className='custom-tabs border-bottom' ref={this.myRef}>
          <ul
            className='nav nav-tabs  respTabsListing border-0 rounded-0 w-100'
            id='myTab'
            role='tablist'
          >
            <li
            ...
            >
              <a
                className={
                  this.state.selectedResponseTab === 'header'
                    ? 'nav-link active text-black'
                    : 'nav-link text-grey'
                }
                style={
            ...
            {isDashboardRoute(this.props) && (
              <>
                ...
                >
                  <a
                    className={
                      this.state.selectedResponseTab === 'testResults'
                        ? 'nav-link active text-black'
                        : 'nav-link text-grey'
                    }
                ...
                >
                  <a
                    className={
                      this.state.selectedResponseTab === 'console'
                        ? 'nav-link active text-black'
                        : 'nav-link text-grey'
                    }
                    style={
                ...
                <div className='d-flex justify-content-between align-items-center mt-3 mb-1'>
                  <ul className='nav nav-pills body-button rounded'>
                    <li
                      ...
                      onClick={() =>
                        this.setState({ selectedBodyTab: 'pretty' })
                      }
                    >
                      <a
                        className={
                          this.state.selectedBodyTab === 'pretty'
                            ? 'nav-link active px-3 py-1 font-10 text-black'
                            : 'nav-link px-3 py-1 font-10 text-grey'
                        }
                      >
                        Pretty
                      </a>
                    ...
                    <li
                      className='nav-item cursor-pointer'
                      onClick={() => this.setState({ selectedBodyTab: 'raw' })}
                    >
                      <a
                        className={
                    ...
                    <li
                      className='nav-item cursor-pointer'
                      onClick={() =>
                        this.setState({ selectedBodyTab: 'preview' })
                      }
                    >
                      <a
                        className={
                  ...
                  {getCurrentUser() &&
                    ...
                    >
                      <div
                        className='adddescLink d-flex align-items-center gap-1 icon-button px-2 py-1'
                        onClick={() => this.handleAddExampleRequest()}
                      >
                  ...
                  {this.state.selectedBodyTab === 'raw' && (
                    <div>
                      ...
                      <>
                        {isDashboardRoute(this.props) && (
                          <div
                            className='tab-content bg-white border rounded'
                            id='myTabContent'
                          >
                            <div
                    ...
                    <div>
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: JSON.stringify(this.props.response.data),
                        }}
                      />
                    </div>
                  )}
  ...
  renderConsole() {
    ...
    return (
      <div className='w-100'>
        ...
        <RenderConsoleComponent
          data={
            showPreScript
              ? tabs?.[activeTabId]?.preScriptExecutedData || []
              : tabs?.[activeTabId]?.postScriptExecutedData || []
          }
        />
      </div>
    );
  ...
  render() {
    ...
    return (
      <div
        className='endpoint-response-container overflow-auto mt-2'
          ...
          this.props?.response?.status ? (
            <div>
              <div className='response-status justify-content-end'>
                <div className='statusWrapper'>
                  ...
                  <div id='time'>
                    ...
                    <div
                      className='response-status-value'
                      style={{ color: theme }}
                    >
                  ...
                  <Overlay
                    target={this.copyDivRef.current}
                    show={this.state.showCopyMessage}
                    placement='top'
                  >
                    <Tooltip id='copy-message'>Copied</Tooltip>
                  </Overlay>
                  <div
                    className='resPubclipboardWrapper'
                    ref={this.copyDivRef}
                    onClick={() => this.showCopyMessage()}
                  >
                    <CopyToClipboard
              ...
              <div className='response-viewer'>
                ...
                {this.state.selectedResponseTab === 'testResults' &&
                  isDashboardRoute(this.props) &&
                  this.props.tests && <TestResults tests={this.props.tests} />}
                {this.state.selectedResponseTab === 'console' &&
                  this.displayConsole()}
              </div>
            </div>
