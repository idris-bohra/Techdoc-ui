...
export const addEndpoint = (
  ...
  newEndpoint.uniqueTabId = sessionStorage.getItem(
...
export const addExampleRequest = (
  navigate,
  id,
  editedEndpoint = null,
  customCallback
  ...
  if (editedEndpoint == null) {
    editedEndpoint = {};
    editedEndpoint.uniqueTabId = sessionStorage.getItem(
      SESSION_STORAGE_KEY.UNIQUE_TAB_ID
    );
  }
  editedEndpoint.uniqueTabId = sessionStorage.getItem(
...
export const deleteEndpoint = (endpoint) => {
  endpoint.uniqueTabId = sessionStorage.getItem(
    SESSION_STORAGE_KEY.UNIQUE_TAB_ID
  );
  return (dispatch) => {
    endpointApiService
