...
export default function RenderFields(props) {
  ...
  return (
    <div>
      <div
        className='d-flex align-items-start schema-data-container'
      ...
      >
        ...
        <div className='d-flex flex-column align-items-start ml-1'>
          <div>
            ...
            {props?.fieldData?.type?.name && (
              <span className='schema-input-type ml-1'>
                {props?.fieldData?.type?.name}
              </span>
            )}
          </div>
      ...
      {props?.fieldData?.args &&
        props?.fieldData?.args?.length > 0 &&
        showFieldArg && (
