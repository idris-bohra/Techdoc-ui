  ...
  render() {
    ...
    return (
      <div
        id='sample-response'
        className={
          isNotDashboardOrDocView(this.props, this.props.currentView)
            ? 'testing-view-sample-response'
            : ''
        }
      >
        {isDashboardRoute(this.props) ? (
          <div className='add-sample-response'>
            <button
              className='adddescLink align-left d-flex align-items-center gap-1 icon-button px-2 py-1'
