  ...
  return (
    <span>
      <button
        ...
        onClick={() =>
          entityName === 'endpoint'
            ? props.approve_endpoint(entity[entityId])
            : props.approve_page(entity[entityId])
        }
      >
        Approve
      </button>
      <button
        ...
        onClick={() =>
          entityName === 'endpoint'
            ? props.reject_endpoint(entity[entityId])
            : props.reject_page(entity[entityId])
        }
      >
        Reject
      </button>
...
export function PublishEntityButton(props) {
  ...
  return (
    <button
      className={
        publishLoader
          ? 'btn buttonLoader btn-secondary outline ml-2 orange btn-sm font-12'
          : 'btn text-grey btn-sm font-12'
      }
      type='button'
...
export function UnPublishEntityButton(props) {
  ...
  return (
    <button
      className={
        publishLoader
          ? 'btn buttonLoader  ml-2 btn-sm font-12'
          : 'btn text-danger btn-sm font-12 button '
      }
      type='button'
      onClick={handleClick}
    >
