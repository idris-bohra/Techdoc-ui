...
function DesktopAppDownloadModal(props) {
  ...
  const shouldShowModal = !window.matchMedia('(display-mode: standalone)')
    .matches;
  ...
  const show =
    shouldShowModal && props.modals.activeModal === DESKTOP_APP_DOWNLOAD;
        ...
        <Modal.Body className='download-app-pop'>
          {props.modals.modalData ? (
            ...
            <h5 className='text-center'>
              Seems you have already used 10 tabs.
            </h5>
          )}
          ...
          <ol>
            <li>
              The desktop agent overcomes the Cross Object Resource Sharing
              (CORS) limitations of browsers
            </li>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(DesktopAppDownloadModal)
);
