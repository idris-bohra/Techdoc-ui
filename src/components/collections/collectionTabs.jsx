      ...
      <ul className='nav nav-tabs border-0 border-bottom w-100 rounded-0 mb-2'>
        <li className='nav-item cursor-pointer'>
          <a
            ...
            onClick={() => {
              router.push(
                `/orgs/${getOrgId()}/dashboard/collection/${collectionId}/settings`
              );
        ...
        <li className='nav-item cursor-pointer'>
          <a
            ...
            onClick={() => {
              router.push(
                `/orgs/${getOrgId()}/dashboard/collection/${collectionId}/feedback`
              );
        ...
        {(orgType === 1 || metaType === null) && (
          <li className='nav-item cursor-pointer'>
            <a
              ...
              onClick={() => {
                router.push(
                  `/orgs/${getOrgId()}/dashboard/collection/${collectionId}/runs`
                );
