...
const techdocLogo = (
  <img src='/maskable_icon_x192.png' alt='Techdoc Logo' height={30} />
);
const openApiLogo = (
  <img src='/placeholder-image_0.jpg' alt='Open API Logo' height={30} />
);
...
const choices = {
  ...
  [exportModalEnum.OPENAPI]: {
    ...
    warningText:
      'Your version and endpoint description will get deleted if you select Open API.',
  },
};
...
const ExportModal = (props) => {
      ...
      {Object.values(choices).map((choice) => (
        <div
          ...
          className={[
            ...
            choiceSelected === choice.key ? 'selected' : '',
          ].join(' ')}
  ...
  return (
    <Modal
      ...
      onHide={props.onHide}
      show={props.show}
      dialogClassName='export-choice-modal'
    >
      <div>
