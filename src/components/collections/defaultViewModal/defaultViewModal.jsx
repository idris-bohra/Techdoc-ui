...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    add_page: (rootParentId, newPage) =>
      dispatch(addPage(rootParentId, newPage)),
  };
};
export class DefaultViewModal extends Form {
  ...
  async doSubmit() {
    ...
    if (
      this.props?.title === 'Add Page' ||
      this.props?.title === 'Add Sub Page' ||
    ...
    return (
      <div className='mt-5'>
        {this.renderInput(
          ...
          false,
          false,
          '*name accepts min 1 & max 100 characters'
        )}
    ...
    return (
      <>
        ...
        <div className='info mt-5 d-flex align-items-center'>
          ...
          <span>
            You can always choose to Test the API's or make the Testing API
            description
          </span>
        </div>
      </>
          ...
          <div>
            ...
            >
              <Modal.Title id='contained-modal-title-vcenter'>
                {'Start adding in your collection'}
              </Modal.Title>
            </Modal.Header>
  ...
  render() {
    return this.props.showOnlyForm
      ? this.renderButtons()
      : this.renderInModal();
  }
}
